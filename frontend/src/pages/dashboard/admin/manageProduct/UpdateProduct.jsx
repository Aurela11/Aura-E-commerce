...
const UpdateProduct = () => {
    ...
    const {name, category, color, description, image:imageUrl, price} = 
    productData?.product || {};
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
         ...
         <div>
            <label htmlFor="description" className='block text-sm font-medium
             ...
             <textarea name="description" id="description" className='add-product-InputCSS'
         ...
         <div>
           <button type='sumbit' className=' add-product-btn'
