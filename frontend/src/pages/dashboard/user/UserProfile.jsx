    ...
    <div className='container mx-auto p-6'>
        <div className='bg-white shadow-md rounded-lg p-6'>
            <div className='flex items-center mb-4'>
              <img src={formData?.profileImage || avatarImg} alt="" className='w-32 h-32 
              ...
              className='ml-auto text-blue-500 hover:text-blue-700'>
                ...
                d='M11 3H4a1 1 0 00-1 1v14a1 1 0 001 1h7m2 0h7a1 1 0 001-1V4a1 1 0 00-1-1h-7m-2 0v14'></path>
            ...
            isModalOpen && (
                ...
                justify-center z-50'>
                   ...
                   <form onSubmit={handleSubmit}>
                    ...
                    <textarea name="bio"
                    row="3" 
                    className='mt-1 p-2 w-full border border-r-gray-300 rounded-md shadow-sm'
                    value={formData?.bio}
                    ...
                    <button className={`mt-4 w-full bg-blue-500 text-white py-2 rounded-md ${isLoading ? 'opacity-50 cursor-not-allowed':''}`}
                             type='submit'
                             disabled={isLoading}
